...
public class ServerCfgFileInfo {
    private static String USER_DIR = ServerCfgFileInfo.class.getClassLoader()
            .getResource("").getPath();
    ...
    private static String CFG_BASE_PATH = USER_DIR + FILE_SEPARATOR
            + CFG_DIRECTORY_NAME + FILE_SEPARATOR;
