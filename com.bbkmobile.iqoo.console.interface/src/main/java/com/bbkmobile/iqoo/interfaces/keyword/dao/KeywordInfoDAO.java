...
public interface KeywordInfoDAO {
    ...
    // boolean deleteCensorWords(CensorWord censorWord, String ids) throws
    // Exception;
    // boolean addCensorWord(CensorWord censorWord) throws Exception;
    //
    // List<Keyword> findKeywordByProperty(int start, Keyword keyword) throws
    // Exception;
    //
    // List<Keyword> getRecommendKeywordInfo(final int start, final Keyword
    // keyword) throws Exception; //获取推荐关键词,分页
    //
    ...
    //
    // boolean updateSequenceAndRank(Long id, int sequence, int rank)throws
    // Exception; //更新序号和出现频率
    //
    // boolean updateRecommendKeyword(Long id, Character recommend)throws
    // Exception; //更新
    //
    // //List<KeywordClick> findClickForKeyword(Keyword keyword) throws
    // Exception;
    //
    // //List<KeywordSearch> findSearchForKeyword(Keyword keyword) throws
    // Exception;
    //
    // List<KeywordClick> findClickForKeyword(Keyword keyword,Date
    // from_date,Date to_date) throws Exception;
    //
    // List<KeywordSearch> findSearchForKeyword(Keyword keyword,Date
    // from_date,Date to_date) throws Exception;
    //
