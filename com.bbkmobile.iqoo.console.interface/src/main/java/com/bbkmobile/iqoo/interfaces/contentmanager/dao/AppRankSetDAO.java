...
public interface AppRankSetDAO {
    List<AppInfo> getScoreTopApps(int order_type_int, int apps_per_page_int,
            int page_index_int, Short model_id, Integer sdkVersion,
    ...
    public List<TopBase> getRankTops(final int order_type_int,
            ...
            final String drawable_dpi, final String CPU_ABI, String tableName)
            throws Exception;

    // ///////
    List<CommonResultAppInfo> getTopApps(PageVO page, TopBase top, Model model,
            String topName) throws Exception;

    List<CommonResultAppInfo> getScoreTopApps(PageVO page, AppInfo appInfo,
