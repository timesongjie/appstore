...
public class ObjectTJson {
    ...
    public static String getAppsJSON(AppInfoListVO vo, String appVersion,
            String cFrom) throws Exception {
        try {
            StringBuffer sb = new StringBuffer();
            if (null != vo) {
                List<RelationRecResultAppInfo> value = appInfosTThis(
                        vo.getAppInfoLs(), appVersion);
     ...
     * @param appVesion
     * @param max
     *            制定返回最大数目应用,并且不需要返回分页信息 -1 表示全返回
     * @return
     * @throws Exception
     */
    public static String getAppsJSON(List<AppInfo> appInfos, String appVersion,
    ...
    public static List<RelationRecResultAppInfo> appInfosTThis(
            List<AppInfo> appInfos, String appVersion) throws Exception {
    ...
    public static RelationRecResultAppInfo appInfoTThis(AppInfo appInfo,
