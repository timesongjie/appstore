...
public interface UserFeedbackDAO {
    ...
    // ;
    //
    String saveComment(RequestParameter requestParameter) throws Exception; // add
                                                                            // by
                                                                            // haiyan
    ...
    //
    // Integer countForbidComments(ForbidComment forbidComment) throws
    // Exception;
    // List<ForbidComment> getForbidComments(ForbidComment forbidComment) throws
    // Exception;
    //
    // boolean deleteForbidComments(ForbidComment forbid_status, String ids)
    // throws Exception;
    //
    // boolean saveForbidCommnet(AppComment appComment, Short forbid_status,
    // String ids, UserInfo user) throws Exception ;
    //
    // ForbidComment getForbidComment(ForbidComment forbidComment) throws
    // Exception;
    //
    // boolean deleteForbidCommentsWithTimed() throws Exception;
    //
    boolean saveDownloadAppStatusLog(RequestParameter requestParameter)
            throws Exception;
    //
    // List<Object[]> getSystemLogList(int start,String ...tableName)throws
    // Exception;
