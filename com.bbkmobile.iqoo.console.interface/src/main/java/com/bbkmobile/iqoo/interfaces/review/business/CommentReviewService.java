...
public interface CommentReviewService {
    ...
    String getAppCommentListForXml(RequestParameter requestParameter)
            throws Exception; // add by haiyan

    String getAppCommentListForJson(RequestParameter requestParameter)
            throws Exception;
    //
    // List<AppComment> getAppCommentList(AppComment appComment, PageVO page)
    // throws Exception;
    //
    // List<AppComment> getAllAppCommentList(AppComment appComment) throws
    // Exception;
    // List<AppComment> getAllAppCommentList1(AppComment appComment) throws
    // Exception;
    //
    ...
    //
    // List<CommentReviewRecords> getCommentReviewRecords(AppComment appComment)
    // throws Exception;
    //
    // // boolean startCommentReview(AppComment appComment) throws Exception;
    //
    // boolean commentReview(CommentReviewRecords review,Integer adminUserId)
    // throws Exception;
    //
    // boolean reviewMoreAppComment(Long[] ids, CommentReviewRecords review,
