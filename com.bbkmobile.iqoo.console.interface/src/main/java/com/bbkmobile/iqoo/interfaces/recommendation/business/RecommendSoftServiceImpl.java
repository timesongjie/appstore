...
public class RecommendSoftServiceImpl implements RecommendSoftService {
    ...
    public List<CommonResultAppInfo> getRecommendAppsForInterface(PageVO page,
        ...
        // }
        return recommendSoftDao.getRecommendAppListForInterface(page, app,
                model);
    }
    ...
    public List<CommonResultAppInfo> getRecommendGamesForInterface(PageVO page,
        ...
        return recommendSoftDao.getRecommendGameListForInterface(page,
                recommendApp, model);
    }
    ...
    // 统一处理url连接问题
    // private List<CommonResultAppInfo> updateUrl(List<CommonResultAppInfo>
    // infos,String app_version) throws Exception{
    // if(infos !=null && infos.size()>0){
    // for(CommonResultAppInfo info : infos){
    // info.setDownload_url(UtilTool.getHttpURL("/appinfo/downloadApkFile?id=" +
    // info.getId()+"&app_version="+app_version));
