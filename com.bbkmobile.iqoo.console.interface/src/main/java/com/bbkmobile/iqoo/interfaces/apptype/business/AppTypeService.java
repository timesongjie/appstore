...
public interface AppTypeService {
    ...
    // begin:手机接口@haiyan
    String getTypeListForXml(String id, String model, String cs, String imei,
            String appVersion) throws Exception;

    String getAppInfoListForTypeForXml(String id, String order_type,
            String apps_per_page, String page_index, String list, String model,
            String cs, String imei, String appVersion) throws Exception;

    // end：手机接口
    String getTypeForJson(String type_id, String cs) throws Exception;

    String getAppByTypeForJson(String model, int typeId, List<String> typeIds,
